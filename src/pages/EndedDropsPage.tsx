...
interface EndedDropsPageProps {
  contract: ethers.Contract | null;
  account: string | null;
}

const EndedDropsPage: React.FC<EndedDropsPageProps> = ({
  contract,
  account,
}) => {
    ...
    const fetchDrops = async () => {
      if (contract) {
        try {
          ...
          console.error("Error fetching ended drops:", error);
        }
      }
    };
    fetchDrops();
  ...
  return (
    <div>
      <h1 className="text-2xl mb-4">Ended Drops</h1>
